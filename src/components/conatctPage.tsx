      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center items-center">
            <div className="relative w-80 h-80 bg-gradient-to-br from-teal-400 to-teal-600 rounded-2xl flex items-center justify-center shadow-2xl">
              {/* Symantrix365 Logo Design */}
              <div className="relative">
                {/* Main curved shape resembling the wood grain pattern from original */}
                <div className="w-40 h-32 bg-gradient-to-r from-yellow-200 via-yellow-300 to-orange-300 rounded-full transform rotate-12 opacity-90 shadow-lg"></div>
